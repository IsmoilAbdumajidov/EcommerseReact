...
const Footer = () => {
  return (
    <div className='bg-[#f3f3f3]'>
      <div className="main-container px-5 sm:px-auto text-[14px] pb-10 pt-14 gap-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6">
        <div className='flex flex-col justify-between lg:col-span-2'>
          ...
          <div>
            <h1 className='text-lg font-semibold mt-3'>NEWSLETTER</h1>
            <div className='flex text-white'>
              <input type="text" className='rounded-s-md p-2  rounded-e-none text-[14px] w-full placeholder:text-gray-400 text-black' placeholder='Your email address' />
